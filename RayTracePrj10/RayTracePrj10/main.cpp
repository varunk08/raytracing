...
#define BIAS_SHADING 1.e-2f
#define _USE_MATH_DEFINES
#define NUM_THREADS  2
#define MIN_N_SAMPLES 10
#define MAX_N_SAMPLES 64
#define H_BASE_1 2
#define H_BASE_2 3
#define SHADE_THRESHOLD 1e-3f
#define MIN_SHADOW_SAMPLES 10
#define MAX_SHADOW_SAMPLES 128
struct RenderParams{
    Point3 K;
    int pixIndex;
    Point2 pixLocation;
...
{
    const char* filename = "/Users/varunk/Desktop/RayTracerProj1/RayTracePrj10/RayTracePrj10/finalScene.xml";
    LoadScene(filename);
