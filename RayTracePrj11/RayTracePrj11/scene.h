...
struct HitInfo
{
    ...
    HitInfo() { Init(); }
    void Init() { z=BIGFLOAT; node=NULL; front=true; uvw.Set(0.5f,0.5f,0.5f); duvw[0].Zero(); duvw[1].Zero(); }
};
...
public:
    ...
    virtual Color Shade(const Cone &ray, const HitInfo &hInfo, const LightList &lights, int bounceCount, bool globalAmbient=false) const=0;
