...
int main(int argc, char **argv)
{
    ...
    char defaultFileName[] = "/Users/varunk/Desktop/RayTracerProj1/RayTracePrj11/RayTracePrj11/photonmap.dat";
    ...
    glColorPointer(3, GL_FLOAT, sizeof(Photon), photons[0].power);
