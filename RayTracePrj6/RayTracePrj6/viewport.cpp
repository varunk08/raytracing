    ...
    if ( mode == MODE_RENDERING ) {
        ...
        if ( lastRenderedPixels != nrp ) {
            ...
            if ( renderImage.IsRenderDone() ) {
                ...
                renderImage.SaveZImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj6/RayTracePrj6/zbuffer.ppm");
                renderImage.SaveImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj6/RayTracePrj6/renderimage.ppm");
            }
            glutPostRedisplay();
        }
    }
