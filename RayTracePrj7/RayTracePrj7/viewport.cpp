    ...
    if ( mode == MODE_RENDERING ) {
        ...
        if ( lastRenderedPixels != nrp ) {
            ...
            if ( renderImage.IsRenderDone() ) {
                ...
                renderImage.SaveZImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj7/RayTracePrj7/zbuffer.ppm");
                renderImage.SaveImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj7/RayTracePrj7/renderimage.ppm");
            }
            glutPostRedisplay();
        }
    }
