    ...
    if ( mode == MODE_RENDERING ) {
        ...
        if ( lastRenderedPixels != nrp ) {
            ...
            if ( renderImage.IsRenderDone() ) {
                ...
                renderImage.SaveZImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj8/RayTracePrj8/zbuffer.ppm");
                renderImage.SaveImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj8/RayTracePrj8/renderimage.ppm");
                renderImage.ComputeSampleCountImage();
                renderImage.SaveSampleCountImage("/Users/varunk/Desktop/RayTracerProj1/RayTracePrj8/RayTracePrj8/samplecountimage.ppm");
            }
            glutPostRedisplay();
        }
    }
